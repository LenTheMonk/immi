...
public class HibernateUtilsOld {
    ...
    private static final SessionFactory factorySingleton = HibernateUtilsOld.createSingletonInstance();
    private static final String DB_NAME = "";
    
    public static SessionFactory getFactorySingleton() {
        return HibernateUtilsOld.factorySingleton;
    }
    
    public static Session getNewSession() {
        return HibernateUtilsOld.factorySingleton.openSession();
    }
    ...
    private static SessionFactory createSingletonInstance() {
        return new Configuration()
                ...
                .setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/" 
                        + HibernateUtilsOld.DB_NAME + "?zeroDateTimeBehavior=convertToNull")
